...
public static class AccountLoginMenu
{
    ...
    public static void ReloadObjects()
    {
        if (LoginButton == null)
        {
            ...
            LoginButton = UObject.Instantiate(BaseButton);
            LoginButtonText = LoginButton.GetComponentInChildren<TextMeshPro>();
            SignupButton = UObject.Instantiate(BaseButton);
            SignupButtonText = SignupButton.GetComponentInChildren<TextMeshPro>();
            SuperNewRolesWebText = UObject.Instantiate(LoginButtonText);
            ...
            UserIdText = UObject.Instantiate(LoginButtonText);
            ...
            SignupPopup = UObject.Instantiate(FastDestroyableSingleton<AccountManager>.Instance.accountTab.editNameScreen);
            ...
            LoginPopup = UObject.Instantiate(FastDestroyableSingleton<AccountManager>.Instance.accountTab.editNameScreen);
