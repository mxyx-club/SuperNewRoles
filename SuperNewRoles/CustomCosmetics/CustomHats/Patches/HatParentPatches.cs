...
namespace SuperNewRoles.CustomCosmetics.CustomHats.Patches;
...
internal static class HatParentPatches
{
    ...
    {
        var dirPath = Path.Combine(CustomHatManager.CustomHatsDir, "Test");
        ...
        {
            Logger.Warn($"Unable to create test hat \n{err}");
            return true;
        }
