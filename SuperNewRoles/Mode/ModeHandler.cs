...
public static class ModeHandler
{
    ...
    public static ISystem.List<PlayerControl> TeamHandler(IntroCutscene __instance)
    {
        ...
        {
            var Data = new ISystem.List<PlayerControl>();
            Data.Add(PlayerControl.LocalPlayer);
            return Data;
        }
        return new ISystem.List<PlayerControl>();
    }
