...
public static class ReplayFileSelector
{
    ...
    public class ShowProgressionPatch
    {
        public static void Postfix()
        {
            ...
            SignInScreen popup = UObject.Instantiate(screen);
            ...
            UObject.Destroy(TitleTMP.GetComponent<TextTranslatorTMP>());
            ...
            UObject.Destroy(InfoTMP.GetComponent<PlatformTextTranslationTMP>());
            ...
            popup.signInButton.OnClick.AddListener((UnityAction)(() =>
            {
                ...
                NameTextBehaviour ntb = UObject.Instantiate(FastDestroyableSingleton<AccountManager>.Instance.accountTab.editNameScreen.nameText, popup.transform);
                ...
                UObject.Destroy(ButtonText.GetComponent<TextTranslatorTMP>());
                ButtonText.text = ModTranslation.GetString("ReplayChangeName");

                PassiveButton cancelbtn = UObject.Instantiate(popup.signInButton, popup.signInButton.transform);
            }));
            TextMeshPro ButtonText = popup.signInButton.transform.FindChild("Text_TMP").GetComponent<TextMeshPro>();
            UObject.Destroy(ButtonText.GetComponent<TextTranslatorTMP>());
            ButtonText.text = ModTranslation.GetString("ReplayChangeName");
    ...
    public class MatchMakerStartPatch
    {
        ...
        public static void Postfix(MatchMaker __instance)
        {
            ...
            Replays = new();
            FileNames = new();
            VersionShower vs = UObject.FindObjectOfType<VersionShower>();
            UObject.Destroy(vs.GetComponent<AspectPosition>());
            vs.transform.localPosition -= new Vector3(0, 0.065f);
            HostLocalGameButton hostlocalgamebutton = UObject.FindObjectOfType<HostLocalGameButton>();
            ...
            UObject.Destroy(titletext.GetComponent<TextTranslatorTMP>());
            ...
            GameDiscovery gamediscovery = UObject.FindObjectOfType<GameDiscovery>();
            ...
            Button = UObject.Instantiate(Button);
            UObject.Destroy(Button.GetComponent<BoxCollider2D>());
            UObject.Destroy(Button.GetComponent<AspectPosition>());
        ...
        public static void CreatePageButton(int page)
        {
            ...
            {
                JoinGameButton button = UObject.Instantiate(prefab, prefabparent);
                Buttons.Add(button);
                ...
                //日時
                TextMeshPro tmp = UObject.Instantiate(button.gameNameText, button.transform);
                ...
                //モード
                tmp = UObject.Instantiate(button.gameNameText, button.transform);
        ...
        public static (GameObject, TextMeshPro) OpenAlert(string alerttext)
        {
            if (AlertTmp == null)
            {
                ...
                GameObject alert = UObject.Instantiate(HelpMenu);
                ...
                UObject.Destroy(AlertTmp.GetComponent<TextTranslatorTMP>());
        ...
        public static void OpenCheckAlert(string alerttext, bool IsNormal, string FileName)
        {
            ...
            HostLocalGameButton game = UObject.FindObjectOfType<HostLocalGameButton>();
            if (okbtn == null)
            {
                okbtn = UObject.Instantiate(game.transform.FindChild("CreateGameButton").GetComponent<PassiveButton>(), alert.transform);
                okbtn.OnClick = new();
            ...
            UObject.Destroy(okbtn.GetComponentInChildren<TextTranslatorTMP>());
        ...
        public static void CreateRoom(string FileName, bool IsNormal)
        {
            ...
            ReplayManager.IsReplayMode = true;
            Info((replay == null).ToString() + ":" + (ReplayManager.CurrentReplay == null).ToString() + ":" + (ReplayManager.CurrentReplay.binaryReader == null).ToString());
            HostLocalGameButton game = UObject.FindObjectOfType<HostLocalGameButton>();
            if (IsNormal)
